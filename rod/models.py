...
class Zgloszenia(models.Model):
   ...
   dron = models.ForeignKey(Drony, models.CASCADE, db_column='Dron', blank=True, null=True)
   trasa = models.ForeignKey(Trasy, models.CASCADE, db_column='Trasa', blank=True, null=True)
   rodzaj_zagrozenia = models.ForeignKey(Zagrozenia, models.CASCADE, db_column='Rodzaj_zagrozenia', blank=True, null=True)
